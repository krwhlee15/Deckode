...
- [X] Resizable panels: left sidebar and right panel width adjustable by dragging dividers
- [X] Custom scrollbar styling: thin, minimal scrollbar matching the dark theme
